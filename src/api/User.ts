...
import { addDoc, collection, doc, getDoc, getDocs, limit, orderBy, query, startAt, updateDoc, where } from "firebase/firestore"
...
export const getUsersByUserName = async (username:string) => {
    const q = query(collection(firebaseDatabase,"/profiles"),orderBy("username"),startAt(username),limit(30))
